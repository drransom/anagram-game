...
var RulesArea = React.createClass({
  ...
  propTypes: {
    ...
    winningWord: React.PropTypes.string
  },
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: "row notification-text-area" },
      React.createElement(
        'span',
  ...
  getMessageType: function () {
    switch (this.props.messageType) {
      case "rules":
        return "Press any letter on the keyboard to guess. " + "One point for each letter. Lose one point if you skip.";
      case "win":
...
var WordGameView = React.createClass({
  ...
  calculateNotificationArea: function () {
    return React.createElement(RulesArea, { shouldBeVisible: !this.notificationShouldBeVisible,
  ...
  calculateScoreArea: function () {
    return React.createElement(
      ...
      React.createElement(ScoreArea, { score: this.score })
    );
  },
  ...
  componentWillReceiveProps: function (nextProps) {
    ...
    } else if (ndexProps.outcome === 'play') {
  ...
  unhideNotification: function (outcome) {
    if (this.notificationShouldBeHidden) {
      ...
      this.notificationShouldBeHidden = false;
      setNotificationUnhiddenTimeout();
    }
  },

  unhideNotificationUnhiddenTimeout: function () {
    var gameView = this;
    setTimeout(function () {
