...
var ControlButtons = React.createClass({
  ...
  generateResetButton: function () {
    ...
    return React.createElement(
      ...
      { type: 'button', className: 'btn btn-primary',
        onClick: this.props.game.resetRound, disabled: disabled },
      'Reset'
    );
  },
  ...
  generateSkipButton: function () {
    ...
    return React.createElement(
      'button',
      { type: 'button', className: 'btn btn-primary',
        onClick: this.props.game.skipToNextWord, disabled: disabled },
      'Skip'
    );
  },
...
var WordGameView = React.createClass({
  ...
  render: function () {
    ...
    if (!this.props.words || this.props.words.length === 0) {
      ...
      lettersArea = React.createElement(
        'div',
        { className: 'row' },
        React.createElement(
          'div',
      ...
      buttonsArea = React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'col xs-6 col-xs-offset-3' },
          React.createElement(ControlButtons, { won: this.props.won,
