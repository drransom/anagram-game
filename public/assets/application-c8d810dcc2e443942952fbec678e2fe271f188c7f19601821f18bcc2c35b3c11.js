...
var RulesArea = React.createClass({
  ...
  render: function () {
    var className = "rules-text";
    if (!(this.props.shouldRender || this.startedHiding)) {
    ...
    return React.createElement(
      ...
      React.createElement(
        'span',
        { hidden: this.props.hidden, className: className },
  ...
  setHiddenTimeout: function () {
    var rulesArea = this;
    this.startedHiding = true;
    setTimeout(function () {
      rulesArea.setProps({ hidden: "hidden" });
    }, 1000);
  }
...
var WordGameView = React.createClass({
  ...
  calculateButtonsArea: function () {
    var controlButtons = calculateControlButtons();
    return React.createElement(
      'div',
  ...
  calculateRulesArea: function () {
    return React.createElement(RulesArea, { shouldRender: !this.hasPlayed });
  }
