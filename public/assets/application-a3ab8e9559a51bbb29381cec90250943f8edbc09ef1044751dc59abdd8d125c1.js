...
var RulesArea = React.createClass({
  ...
  render: function () {
    ...
    className += this.props.shouldRender ? '' : ' hidden-rules-text';
    hidden = this.props.shouldBeHidden ? 'hidden' : '';
    return React.createElement(
      'div',
      { className: "row rules-text-area" },
      React.createElement(
        'span',
        { hidden: hidden, className: className },
        'Press any letter on the keyboard to guess. One point for each letter. Lose one point if you skip.'
      )
    );
  },
...
var WordGameView = React.createClass({
  ...
  propTypes: {
    ...
    currentScore: React.PropTypes.number
  },
  ...
  render: function () {
    ...
    if (this.props.won) {
      ...
      return React.createElement(
        'div',
        { className: 'row vertical-margin-row' },
        React.createElement(
          'div',
          { className: 'col-lg-12' },
          [rulesArea, lettersArea, buttonsArea, scoreArea]
        )
      );
    }
  },
  ...
  calculateLetters: function () {
    ...
    for (i = 0; i < this.props.currentGuess.length; i++) {
      ...
      letters.push(React.createElement(WordGameLetter, { char: char, active: true,
        key: 'letter-' + i }));
    }
    for (j = 0; j < this.props.scrambledChars.length; j++) {
      char = this.props.scrambledChars[j];
      letters.push(React.createElement(WordGameLetter, { char: char, active: false,
        key: 'letter-' + i + j }));
    }
    return letters;
  },
  ...
  calculateLettersArea: function () {
    ...
    return React.createElement(
      'div',
      { className: 'row letters-row' },
      React.createElement(
        'div',
        { className: 'letters-area' },
        letters
      )
    );
  },
  ...
  calculateControlButtons: function () {
    return React.createElement(ControlButtons, { won: this.props.won,
  ...
  calculateRulesArea: function () {
    return React.createElement(RulesArea, { shouldRender: !this.rulesStartedHiding,
  ...
  calculateScoreArea: function () {
    return React.createElement(
      'div',
      { className: 'row score-row' },
      React.createElement(ScoreArea, { score: this.currentScore })
    );
  },
...
window.ECRWordGame = window.ECRWordGame || {};

ECRWordGame.shuffle = function (array) {
...
Game.prototype.checkVictory = function() {
  if (this.currentGuess === this.unusedLetters) {
