...
var WordGameView = React.createClass({
  ...
  calculateRulesArea: function () {
    return React.createElement(RulesArea, { shouldRender: !this.props.hasStartedHiding,
  ...
  componentWillReceiveProps: function () {
    ...
    if (this.props.hasPlayed && !this.props.hasStartedHiding) {
  ...
  setRulesHiddenTimeout: function () {
    GameUI;
    var gameView = this;
    this.setProps({ rulesStartedHiding: true });
    setTimeout(function () {
